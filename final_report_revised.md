...
<!-- AUTHOR NOTE — CITATION VERIFICATION. REMOVE BEFORE SUBMISSION. -->

<!-- ============================================================= -->

## Author note — citation verification (remove before submission)

For each citation used in the report, the source and the specific content it supports are listed below. Claims marked **VERIFIED** are taken from a source read in full while preparing this draft. Claims marked **CHECK** rely on a source not available during drafting, or on data only you hold (Singstat), and should be confirmed before submission.

**Chen, Yip and Yap (2018) — read in full. VERIFIED.**
Supports, with the passage in the paper: TFR was 4.6 children per woman in 1965 at independence ("In 1965 when Singapore gained independence from Malaysia, its TFR was 4.6 children per woman"); anti-natalist family-planning programmes ran 1965–1986 and the TFR reached replacement level in 1975; the 1987 pro-natalist turn at TFR ≈ 1.6 under the slogan "Three or more, if you can afford it"; the Marriage and Parenthood Package and Baby Bonus (cash gifts plus matched co-savings); Singapore's TFR was 1.19 in 2014, among the lowest in the region; and housing affordability and delayed marriage are central barriers to fertility. _Caution:_ the specific name "Stop at Two" and the 1966 "Family Planning and Population Board" are NOT in this paper — they are well-known historical facts but should be cited to a Singapore government / historical source if you keep them. I have used the neutral phrase "family-planning programmes (Chen, Yip and Yap, 2018)" instead.

**Shair, Shaadan and Meor Amirudin (2024) — read in full. VERIFIED.**
Supports: global average fertility fell from 5.068 (1960) to 2.300 (2021) per the paper's opening; the Lee–Carter and functional data approach; the use of `auto.arima` to forecast the component series; the explicit avoidance of higher-order models to prevent overfitting on a short series ("too many parameters may result in complex and overfitting modelling"); and the use of a logarithmic scale for fertility in the Lee–Carter formulation.

**Lee (1993). VERIFIED (web, 2026-06).**
Confirmed: Lee, R. D. (1993), _International Journal of Forecasting_ 9(2), 187–202 — title, journal, volume/issue and pages all match the reference list (issue number "(2)" added). Cited for the standard argument that fertility is strictly positive and best modelled on a log scale.

**Vanella (2016). VERIFIED (web, 2026-06).**
Confirmed: Patrizio Vanella, _The Total Fertility Rate in Germany until 2040 — A Stochastic Principal Components Projection based on Age-specific Fertility Rates_, Hannover Economic Papers (HEP) No. 579 (2016); method confirmed as PCA on age-specific fertility rates with the components modelled as stochastic time series. NOTE: the abstract does **not** state a "short demographic series limits precision" caveat, so that claim was removed from §1.3; the short-series / overfitting concern is now attributed only to Shair, Shaadan and Meor Amirudin (2024), where it is explicit. The unverified "Box–Jenkins (ARIMA-type)" phrasing was also removed.

**Agarwal et al. (2021), "Fortunes of dragons". CORRECTED + VERIFIED (web, 2026-06). — IMPORTANT.**
The earlier reference was **wrong**: it listed authors "Tan, R., and Yeap, B. Y." and gave the year as 2015 (NUS working paper). The verified published paper is Agarwal, S., Qian, W., Sing, T. F., and Tan, P. L. (2021), "Fortunes of dragons: Cohort size effects on life outcomes", _Population Studies_ 75(2), 191–207 (DOI 10.1080/00324728.2020.1864458). Authors, year and venue have been corrected throughout — all in-text cites now read 2021. The paper reports that, between 1960 and 2007, births among the Chinese majority rose by about **9.7%** in Dragon years with no comparable pattern in other groups; this verified magnitude is now stated in §1.1. (A 2017 working-paper version also exists; cite that instead only if your marker prefers the working paper.)

**Box, Jenkins and Reinsel (2008); Shumway and Stoffer (2011); Hyndman and Khandakar (2008); Hyndman and Athanasopoulos (2021); R Core Team (2025). Standard methodological/software references.**
Cited for the Box–Jenkins three-stage methodology, the ARIMA/SARIMA framework, the `forecast` package and `auto.arima`, and the R environment. These are textbook/software citations; confirm editions match your reference style.

**Singapore Department of Statistics. VERIFIED against the project dataset.**
Source of the TFR and TLB series and of every specific value quoted. The numbers in the text were computed from `cleaned_tlb_tfr_1960_2024.csv` and confirmed: TFR 5.76 (1960) and 0.97 (2023 and 2024); TLB 61,775 (1960) and 33,703 (2024); the 1987 → 1988 birth rise (43,616 → 52,957); and the Dragon years 1964, 1976, 1988, 2000, 2012, 2024. All model statistics (coefficients, AIC, Ljung–Box _p_, and the test-set MSE/MAE/MAPE in Tables 2–4) were produced by re-fitting the models on the training period 1960–2012. Confirm that the dataset itself matches the current Singstat tables before submission, since these are the figures a marker is most likely to check. The "≈74% Chinese" proportion is now stated as "about three-quarters" and cited to Singapore Department of Statistics (2025) — VERIFIED (web): residents were 73.9% Chinese in 2025, so "about three-quarters" is accurate. A separate _Population trends 2025_ reference was added for this.
