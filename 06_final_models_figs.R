...
dev.off(); cat("\nwrote figures/fr2_fig3_initial_resid_acf.png\n")
...
suppressWarnings(checkresiduals(tfr_impr)); dev.off(); cat("wrote figures/fr2_fig4_resid_tfr.png\n")
png("figures/fr2_fig5_resid_tlb.png", width = 980, height = 720, res = 120, bg = "white")
suppressWarnings(checkresiduals(tlb_impr)); dev.off(); cat("wrote figures/fr2_fig5_resid_tlb.png\n")
