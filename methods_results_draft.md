...
![Figure 1: Singapore TFR with policy events and Zodiac years](plots/fig1_tfr_raw.png)
...
![Figure 3: First-differenced TLB and TFR with fixed y-axis](plots/fig3_diff_series.png)
...
![Figure 4a: ACF and PACF of first-differenced TFR](plots/fig4a_acf_pacf_diff_tfr.png)

### Figure 4b — ACF and PACF of First-Differenced TLB (lag.max = 50)

![Figure 4b: ACF and PACF of first-differenced TLB](plots/fig4b_acf_pacf_diff_tlb.png)
