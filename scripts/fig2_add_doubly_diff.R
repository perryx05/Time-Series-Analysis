# Regenerate Figure 2 (figures/fr_fig1_acf_pacf.png) to show BOTH the
...
png("figures/fr_fig1_acf_pacf.png", width = 2950, height = 3300, res = 300, bg = "white")
...
cat("wrote figures/fr_fig1_acf_pacf.png\n")
